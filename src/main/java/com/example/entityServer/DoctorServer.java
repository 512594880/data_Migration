...
public class DoctorServer extends AuditableEntity {
    ...
    @Column(name = "profile_state", columnDefinition = "tinyint(2) DEFAULT 0 COMMENT '资料完善状态:1-未完善;2-已完善;'")
    private DoctorProfileState profileState;// 资料完善状态
    ...
    @Column(name = "account_state", columnDefinition = "tinyint(1) unsigned default 1 comment '账户状态:1-活跃中;2-锁定中（临时停用);3-已注销(永久停用)'")
