 ...
 * @author harryhe
 */
@EnumTag(key = "citizen_occupation_type", name = "居民证件类型")
public enum CitizenOccupationType implements IntEnum, Describable {
    /**
    ...
    private CitizenOccupationType(Integer key, String desc) {
        this.key = key;
        this.desc = desc;
    }
